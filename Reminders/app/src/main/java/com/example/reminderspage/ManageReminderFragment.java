...
import com.example.reminderspage.databinding.FragmentManageremindersBinding;
        ...
        binding.buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(ManageReminderFragment.this)
                        .navigate(R.id.action_ManageReminder_to_FirstFragment);
            }
        });
    }
                    ...
                    popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            if (menuItem.getItemId() == R.id.editReminder) {
                                ...
                                NavHostFragment.findNavController(ManageReminderFragment.this)
                                        .navigate(R.id.action_ManageReminder_to_SecondFragment);
